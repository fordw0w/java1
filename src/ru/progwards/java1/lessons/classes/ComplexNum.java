...
//    int b = (this.b * num.a) + (this.a * num.b);
    return new ComplexNum(a * num.a - b * num.b - b * num.b, b * num.a + a * num.b);
}
...
//   int b = (this.b * num.a - this.a * num.b) / i;
        return new ComplexNum(a * num.a + num.b * num.b / (num.a * num.a + num.b * num.b),(b * num.a - a * num.b) / (num.a * num.a + num.b * num.b));
    }
